  ...
  if ('undefined' != typeof window && window.addEventListener) {
    var e,
      ...
      u = function () {
        ...
        ;(window.addEventListener('resize', i, !1),
          ...
          window.MutationObserver
            ? ((e = new MutationObserver(i)).observe(document.documentElement, {
                childList: !0,
                subtree: !0,
                attributes: !0,
              }),
            ...
            : (document.documentElement.addEventListener('DOMSubtreeModified', i, !1),
              (r = function () {
      ...
      s = function (e) {
        function t(e) {
          var t
          return (
            void 0 !== e.protocol ? (t = e) : ((t = document.createElement('a')).href = e),
        ...
        return (
          window.XMLHttpRequest &&
            ...
            (i = t(e)),
            (n =
              void 0 === n.withCredentials && '' !== i && i !== o
    ...
    ;((e = function () {
      ...
      function b(e) {
        return function () {
          !0 !== o[e.base] &&
            (e.useEl.setAttributeNS(d, 'xlink:href', '#' + e.hash),
      ...
      for (r(), f = document.getElementsByTagName('use'), a = 0; a < f.length; a += 1) {
        ...
        ;((e = (h =
          (i =
            ...
            f[a].getAttributeNS(d, 'href') ||
            f[a].getAttribute('xlink:href')) && i.split
            ? i.split('#')
            : ['', ''])[0]),
          (n = h[1]),
          (l = t && 0 === t.left && 0 === t.right && 0 === t.top && 0 === t.bottom),
          t && 0 === t.width && 0 === t.height && !l
            ? (f[a].hasAttribute('href') && f[a].setAttributeNS(d, 'xlink:href', i),
              e.length &&
                (!0 !== (m = o[e]) && setTimeout(b({ useEl: f[a], base: e, hash: n }), 0),
                void 0 === m &&
                  void 0 !== (c = s(e)) &&
                  ((m = new c()),
                  (o[e] = m),
                  ...
                  (w += 1))))
            : l
              ? e.length && o[e] && setTimeout(b({ useEl: f[a], base: e, hash: n }), 0)
              : void 0 === o[e]
                ? (o[e] = !0)
                : o[e].onload && (o[e].abort(), delete o[e].onload, (o[e] = !0)))
      }
      ;((f = ''), (w += 1), v())
    }),
      (n = function () {
